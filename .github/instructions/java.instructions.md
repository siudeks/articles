...
- **Null Handling**: Avoid returning or accepting `null`. Prefer JSpecify @NullMarked and used locally @Nullable to defined null for possibly-absent values, use `Objects` utility methods like `equals()` and `requireNonNull()`.
